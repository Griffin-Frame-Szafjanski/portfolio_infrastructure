...
// Security Configuration - NO FALLBACK for JWT_SECRET (security requirement)
...
if (process.env.JWT_SECRET.length < 32) {
  throw new Error(
    `JWT_SECRET must be at least 32 characters long (current: ${process.env.JWT_SECRET.length}). ` +
    'Generate a secure secret with: openssl rand -base64 32'
  );
}

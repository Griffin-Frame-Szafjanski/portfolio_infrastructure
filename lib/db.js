...
export async function createProject(data) {
  ...
  const result = await db`
    INSERT INTO projects (
      ...
      project_url, github_url, image_url, video_url, pdf_url, pdf_file_key,
      demo_type, display_order, featured
    ) VALUES (
      ${title}, ${description}, ${long_description}, ${tech_stack}, ${technologies},
      ${project_url}, ${github_url}, ${image_url}, ${video_url}, ${pdf_url || null}, ${pdf_file_key || null},
      ${demo_type || 'none'}, ${display_order || 0}, ${featured || false}
    )
    RETURNING *
  `;

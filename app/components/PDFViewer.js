...
export default function PDFViewer({ pdfUrl, title = 'PDF Document', showHeader = false }) {
  if (!pdfUrl) {
    return (
      <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-12 text-center transition-colors">
        <svg className="w-16 h-16 mx-auto text-gray-400 dark:text-gray-500 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
        </svg>
        <p className="text-gray-600 dark:text-gray-300">No PDF available</p>
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">Upload a PDF in the admin panel</p>
      </div>
    );
  }

  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg transition-colors" style={{ padding: showHeader ? '1.5rem' : '0' }}>
      {showHeader && (
